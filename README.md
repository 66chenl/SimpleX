...
+ Dataset config
    ...
    ```python
    data_root: ../../data/Yelp18/  # data directory to save h5 data
    data_format: csv  # input data format
    train_data: ../../data/Yelp18/yelp18_m1/train.csv  # training data path
    valid_data: ../../data/Yelp18/yelp18_m1/test.csv  # validation data path
    test_data: ../../data/Yelp18/yelp18_m1/test.csv  # test data path
    item_corpus: ../../data/Yelp18/yelp18_m1/item_corpus.csv  # item corpus which maps corpus_index to item features
    ...
    # feature_cols can be defined as follows:
...
+ Follow the steps below to reproduce the results
    ...
    # run the model
    python run_expid.py --config ./config/SimpleX_amazonbeatuty_m1 --expid SimpleX_amazonbeatuty_m1 --gpu 0
    ```
